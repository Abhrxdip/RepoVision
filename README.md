...
**RepoVision** is a powerful full-stack AI toolset designed to help developers understand, navigate, and maintain large codebases. It provides an interactive dashboard, automated security scans, AI-powered PR reviews, and a command-line interface to streamline technical onboarding and repository analysis.

Built by Abhradip | Open Source | MIT License
...
- **💻 Developer CLI**: A powerful terminal tool (`repovision`) to index, scan, and generate overviews directly from your workspace.
...
1.  **CLI/SDK**: The `repovision` CLI communicates with the **RepoVision SDK**.
...
2.  **Index a Repository**:
    ```bash
    repovision index https://github.com/user/repo
    ```

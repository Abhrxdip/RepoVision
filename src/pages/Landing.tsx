...
const FAQ = [
  {
    q: "How does RepoVision index my repository?",
  ...
  },
  {
    ...
    a: "RepoVision is language-agnostic. It works with any GitHub repository regardless of language, framework, or project structure.",
  },
  {
  ...
  const content = compact ? (
    <div className="h-screen flex flex-col bg-background p-3">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="font-mono text-xs font-medium text-foreground">RepoVision</span>
      </div>
      <div className="mb-3">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-background/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-14 px-6">
          <div className="flex items-center gap-2 group cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="font-mono text-sm font-bold tracking-tighter uppercase transition-colors group-hover:text-primary">RepoVision</span>
          </div>
